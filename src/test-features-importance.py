...
def compute_feature_importance(model):
    ...
    children_left = model.tree_.children_left  # id of the left child of node i or -1 if leaf node
    children_right = model.tree_.children_right  # id of the right child of node i or -1 if leaf node
...
if __name__ == "__main__":
    ...
    plot_feature_importance(
        model, dataset, title="Decision Tree")
